...
class TestIatkClient(TestCase):
    def setUp(self):
        ...
        self.iatkClient = aws_iatk.AwsIatk
    ...
    def test_event_registered_lambda(self):
        ...
        self.iatkClient.patch_aws_client(self,self.clientLambda)
    ...
    def test_event_registered_api_gateway(self):
        ...
        self.iatkClient.patch_aws_client(self,self.clientApiGateway)
    ...
    def test_event_registered_step_functions(self):
        ...
        self.iatkClient.patch_aws_client(self,self.clientSfn)
