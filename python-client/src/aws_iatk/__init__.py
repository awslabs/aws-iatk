...
class AwsIatk:
    ...
    def get_trace_tree(
        self, tracing_header: str, fetch_child_traces: bool
    ) -> GetTraceTreeOutput:
        """
    ...
    def retry_get_trace_tree_until(self, tracing_header: str, fetch_child_traces: bool, assertion_fn: Callable[[GetTraceTreeOutput], None], timeout_seconds: int = 30):
        """
